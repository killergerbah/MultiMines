...
ms.CCMinesweeperGameLayer = cc.Layer.extend({
	...
	displayScore: (score, userId)->
		if not @_scoreLabels[userId]?
			...
			scoreLabel.setPosition(ms.Instance.CANVAS_WIDTH - ms.Constants.GAME_PADDING_X - @_scoreCount * ms.Constants.SCORE_WIDTH - 5, ms.Constants.GAME_PADDING_Y)
